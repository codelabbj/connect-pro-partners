...
const translations = {
  en: {
    ...
    "dashboard.adminDashboard": "Partner Dashboard",
    ...
    "payment.depositDescription": "Send money to a user's Mobile Money account.",
    "payment.withdrawDescription": "Withdraw money from a user's Mobile Money account.",
    ...
    "payment.confirmTransaction": "Confirm Transaction",
    ...
    "bulkPayment.uploadExcel": "Upload Excel",
    "bulkPayment.uploading": "Uploading...",
    "bulkPayment.invalidPhone": "Phone must be numeric and max 10 digits",
    "bulkPayment.invalidAmount": "Amount must be between min and max",
    "bulkPayment.invalidNetwork": "Invalid network",
    "bulkPayment.rowsPerPage": "Rows per page",
    "bulkPayment.page": "Page",
    "bulkPayment.errors": "Errors found in rows",
    ...
    "partners.pageOf": "Page current of total",
    ...
    "topup.createAutoRecharge": "Create Auto-Recharge",
    "topup.normalRecharge": "Normal Recharge",
    "topup.autoRecharge": "Auto-Recharge",
    "topup.network": "Network",
    "topup.phoneNumber": "Phone Number",
    "topup.selectNetwork": "Select Network",
    "topup.processing": "Processing",
    "topup.success": "Success",
    "topup.failed": "Failed",
    "topup.cancelled": "Cancelled",
    "topup.createdSuccessfully": "Created successfully",
    "topup.createFailed": "Failed to create",
    "topup.detailLoaded": "Details loaded",
    "topup.detailLoadedSuccessfully": "Details loaded successfully",
    "topup.detailFailed": "Failed to load details",
    "topup.loadedSuccessfully": "Loaded successfully",
    "topup.fillAllFields": "Please fill all fields",
    "topup.limit": "Limit",
    ...
    "earning.pageOf": "Page current of total",
  ...
  fr: {
    ...
    "payment.depositDescription": "Envoyer de l’argent vers le compte Mobile Money d’un utilisateur.",
    "payment.withdrawDescription": "Retirer de l’argent du compte Mobile Money d’un utilisateur.",
    ...
    "payment.confirmTransaction": "Confirmer la transaction",
    ...
    "bulkPayment.uploadExcel": "Charger Excel",
    "bulkPayment.uploading": "Chargement...",
    "bulkPayment.invalidPhone": "Le numéro doit être numérique et max 10 chiffres",
    "bulkPayment.invalidAmount": "Le montant doit être entre le min et le max",
    "bulkPayment.invalidNetwork": "Réseau invalide",
    "bulkPayment.rowsPerPage": "Lignes par page",
    "bulkPayment.page": "Page",
    "bulkPayment.errors": "Erreurs trouvées dans les lignes",
    ...
    "partners.pageOf": "Page {current} sur {total}",
    "partners.showingResults": "Affichage de {start} à {end} sur {total} résultats",
    // Top Up Page
    ...
    "topup.createAutoRecharge": "Créer une Auto-Recharge",
    "topup.normalRecharge": "Recharge Normale",
    "topup.autoRecharge": "Auto-Recharge",
    "topup.network": "Réseau",
    "topup.phoneNumber": "Numéro de téléphone",
    "topup.selectNetwork": "Sélectionner un réseau",
    "topup.processing": "En traitement",
    "topup.success": "Succès",
    "topup.failed": "Échec",
    "topup.cancelled": "Annulé",
    "topup.createdSuccessfully": "Créé avec succès",
    "topup.createFailed": "Échec de la création",
    "topup.detailLoaded": "Détails chargés",
    "topup.detailLoadedSuccessfully": "Détails chargés avec succès",
    "topup.detailFailed": "Échec du chargement des détails",
    "topup.loadedSuccessfully": "Chargé avec succès",
    "topup.fillAllFields": "Veuillez remplir tous les champs",
    "topup.limit": "Limite",
    // Earning Management Page
    ...
    "earning.pageOf": "Page current sur total",
    "earning.showingResults": "Affichage de start à end sur total résultats",
    // User Detail Modal - is_partner toggle
